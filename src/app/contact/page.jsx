              ...
              <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div className="mb-12 max-w-[570px] lg:mb-0">
                  ...
                  <p className="mb-9 text-base leading-relaxed text-body-color">
                    At Vishveshwar Oil, we are committed to delivering
                    exceptional service and innovative solutions tailored to
                    your needs. Our team of experts is dedicated to ensuring
                    your success through our comprehensive range of products and
